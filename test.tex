...
\hfill\break
Polska jest zamieszkana przez \textbf{37 672 367} ludzi (2020), zajmuje pod względem liczby ludności \textbf{38.} miejsce \underline{\textit{na świecie}}, a \textbf{5.} w \underline{\textit{Unii Europejskiej.}} \\
...
Polska jest krajem jednolitym etnicznie – \textbf{97\% ludności deklaruje narodowość polską.}\\
...
\subsection{\underline{Partie polityczne}}
\hfill\break
...
\end{itemize}
\hfill\break
\subsection{\underline{Prezydenci}}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[scale=0.5]{andrzej}
\end{center}
